...
void apply_rotation(Gtk::Widget& widget, std::string rotation){ // doing this allows having rotated wigdets without a css file, as with the now deprecated Gtk::Widget::set_angle
